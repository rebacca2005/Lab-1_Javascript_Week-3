...
'It was 94 fahrenheit outside, so :insertx: went for a walk. When they got to :inserty:, they stared in horror for a few moments, then :insertz:. :insertx: saw the whole thing, but they were not surprised — :insertx: weighs 300 pounds, and it was a hot day.'
*/
var storyText =
    'It was 94 fahrenheit outside, so :insertx: went for a walk. When they got to :inserty:, they stared in horror for a few moments, then :insertz:.Bob saw the whole thing, but they were not surprised — :insertx: weighs 300 pounds, and it was a hot day.';
...
function result() {
    ...
    if (customName.value !== "") {
        // Use regular expression with 'g' flag to replace all occurrences of 'Bob' with the custom name
